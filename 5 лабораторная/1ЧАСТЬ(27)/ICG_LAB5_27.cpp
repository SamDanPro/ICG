...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pGround->LoadMesh("C:/TEXTURE/quad.obj")) {
            return false;
        }

        if (!m_billboardList.Init("C:/TEXTURE/monster_hellknight.png")) {
            return false;
        }

        m_pTexture = new Texture(GL_TEXTURE_2D, "C:/TEXTURE/bricks.jpg");
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "27")) {
        return 1;
    }
