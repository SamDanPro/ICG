...
#include "mesh.h"
#include "skybox.h"
//#pragma comment(linker, "/NODEFAULTLIB:libc.lib")//add
#define WINDOW_WIDTH  1920
#define WINDOW_HEIGHT 1200
//#define GLEW_STATIC//add
...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pTankMesh->LoadMesh("C:/TEXTURE/phoenix_ugv.md2")) {
            return false;
        }
        ...
        if (!m_pSkyBox->Init(".",
            "C:/TEXTURE/sp3right.jpg",//jpg
            "C:/TEXTURE/sp3left.jpg",
            "C:/TEXTURE/sp3top.jpg",
            "C:/TEXTURE/sp3bot.jpg",
            "C:/TEXTURE/sp3front.jpg",
            "C:/TEXTURE/sp3back.jpg")) {
            return false;
        }
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "25")) {
        return 1;
    }
